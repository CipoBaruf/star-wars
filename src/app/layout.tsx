...
export const metadata: Metadata = {
  ...
  description: "Search with Star Wars Yoda Intelligence: The new deep space galaxy AI",
};
      ...
      >
        <header className="w-full border-b border-border bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <nav className="max-w-5xl mx-auto flex items-center gap-6 p-4">
            ...
            <a href="/spaceships-and-vehicles" className="hover:underline">Spaceships & Vehicles</a>
          </nav>
        </header>
        {children}
      </body>
